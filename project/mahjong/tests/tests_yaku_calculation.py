...
class YakuCalculationTestCase(unittest.TestCase, TestMixin):
    ...
    def test_fu_calculation(self):
        ...
        tiles = self._string_to_136_array(sou='12378', man='123456', pin='22')
        ...
        self.assertEqual(2, hand.calculate_additional_fu(win_tile, hand_tiles, player_wind, round_wind, [], []))
        ...
        win_tile = self._string_to_136_tile(sou='6')
        hand_tiles = self._hand(self._to_34_array(tiles + [win_tile]), 0)
        self.assertEqual(4, hand.calculate_additional_fu(win_tile, hand_tiles, player_wind, round_wind, [], []))
        ...
        self.assertEqual(16, hand.calculate_additional_fu(win_tile, hand_tiles, player_wind, round_wind, [],
                                                          called_kan_indices))
        ...
        called_kan_indices = [self._string_to_34_tile(sou='2')]
        open_sets = [self._string_to_open_34_set(sou='222')]
        self.assertEqual(8, hand.calculate_additional_fu(win_tile, hand_tiles, player_wind, round_wind, open_sets,
                                                         called_kan_indices))
        ...
        win_tile = self._string_to_136_tile(sou='6')
        hand_tiles = self._hand(self._to_34_array(tiles + [win_tile]), 0)
        self.assertEqual(8, hand.calculate_additional_fu(win_tile, hand_tiles, player_wind, round_wind, [], []))
        ...
        self.assertEqual(32, hand.calculate_additional_fu(win_tile, hand_tiles, player_wind, round_wind, [],
                                                          called_kan_indices))
        ...
        called_kan_indices = [self._string_to_34_tile(sou='1')]
        open_sets = [self._string_to_open_34_set(sou='111')]
        self.assertEqual(16, hand.calculate_additional_fu(win_tile, hand_tiles, player_wind, round_wind, open_sets,
                                                          called_kan_indices))
    ...
    def test_is_chitoitsu_hand(self):
        ...
        tiles = self._string_to_136_array(sou='113355', man='113355', pin='1')
        win_tile = self._string_to_136_tile(pin='1')
    ...
    def test_is_tanyao(self):
        ...
        tiles = self._string_to_136_array(sou='234567', man='23456', pin='22')
    ...
    def test_is_pinfu_hand(self):
        ...
        tiles = self._string_to_136_array(sou='123456', man='12345', pin='55')
        ...
        tiles = self._string_to_136_array(sou='123456', man='12355', pin='55')
        win_tile = self._string_to_136_tile(man='5')
        result = hand.estimate_hand_value(tiles, win_tile)
        self.assertNotEqual(result['error'], None)

        # contains pon or kan
        tiles = self._string_to_136_array(sou='111456', man='12345', pin='55')
        win_tile = self._string_to_136_tile(man='6')
        result = hand.estimate_hand_value(tiles, win_tile)
        self.assertNotEqual(result['error'], None)
        ...
        # not valued pair
        tiles = self._string_to_136_array(sou='12378', man='123456', honors='22')
        win_tile = self._string_to_136_tile(sou='6')
        result = hand.estimate_hand_value(tiles, win_tile)
        self.assertEqual(result['error'], None)
        self.assertEqual(result['han'], 1)
    ...
    def test_is_iipeiko(self):
        ...
        tiles = self._string_to_136_array(sou='112233', man='33', pin='12344')
    ...
    def test_is_ryanpeiko(self):
        ...
        tiles = self._string_to_136_array(sou='112233', man='33', pin='22344')
    ...
    def test_is_sanshoku(self):
        ...
        tiles = self._string_to_136_array(sou='123456', man='1399', pin='123')
    ...
    def test_is_sanshoku_douko(self):
        ...
        tiles = self._string_to_136_array(sou='222', man='222', pin='2224569')
    ...
    def test_is_toitoi(self):
        ...
        tiles = self._string_to_136_array(sou='111333', man='333', pin='4455')
    ...
    def test_is_sankantsu(self):
        ...
        tiles = self._string_to_136_array(sou='111333', man='12', pin='44555')
        open_sets = [self._string_to_open_34_set(sou='111'), self._string_to_open_34_set(sou='333')]
        win_tile = self._string_to_136_tile(man='3')
    ...
    def test_is_honroto(self):
        ...
        tiles = self._string_to_136_array(sou='111999', man='111', honors='1122')
    ...
    def test_is_sanankou(self):
        ...
        tiles = self._string_to_136_array(sou='123444', man='333', pin='4455')
        win_tile = self._string_to_136_tile(pin='5')
    ...
    def test_is_shosangen(self):
        ...
        tiles = self._string_to_136_array(sou='123', man='345', honors='5566677')
    ...
    def test_is_chanta(self):
        ...
        tiles = self._string_to_136_array(sou='123', man='123789', honors='2233')
    ...
    def test_is_junchan(self):
        ...
        tiles = self._string_to_136_array(sou='79', man='123789', pin='12399')
    ...
    def test_is_honitsu(self):
        ...
        tiles = self._string_to_136_array(man='123455667', honors='1112')
        win_tile = self._string_to_136_tile(honors='2')
    ...
    def test_is_chinitsu(self):
        ...
        tiles = self._string_to_136_array(man='1234567677889')
    ...
    def test_is_ittsu(self):
        ...
        tiles = self._string_to_136_array(man='123456789', sou='12', honors='22')
        win_tile = self._string_to_136_tile(sou='3')
    ...
    def test_is_haku(self):
        ...
        tiles = self._string_to_136_array(sou='234567', man='23422', honors='55')
    ...
    def test_is_hatsu(self):
        ...
        tiles = self._string_to_136_array(sou='234567', man='23422', honors='66')
    ...
    def test_is_chun(self):
        ...
        tiles = self._string_to_136_array(sou='234567', man='23422', honors='77')
        win_tile = self._string_to_136_tile(honors='7')
    ...
    def test_is_east(self):
        ...
        tiles = self._string_to_136_array(sou='234567', man='23422', honors='11')
    ...
    def test_is_south(self):
        ...
        tiles = self._string_to_136_array(sou='234567', man='23422', honors='22')
        win_tile = self._string_to_136_tile(honors='2')
    ...
    def test_is_west(self):
        ...
        tiles = self._string_to_136_array(sou='234567', man='23422', honors='33')
        win_tile = self._string_to_136_tile(honors='3')
    ...
    def test_is_north(self):
        ...
        tiles = self._string_to_136_array(sou='234567', man='23422', honors='44')
